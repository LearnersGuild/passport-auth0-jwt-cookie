...
var authMiddleware = exports.authMiddleware = _passport2.default.authenticate('auth0', {
  connection: 'google-oauth2',
  scope: 'openid email'
});

var getCallbackMiddleware = exports.getCallbackMiddleware = function getCallbackMiddleware(failureRedirect) {
  return _passport2.default.authenticate('auth0', { failureRedirect: failureRedirect });
};
