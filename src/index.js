...
export default function configureAuth0(app, {domain, clientID, clientSecret, authURL, callbackURL, jwtIgnorePaths}) {
  ...
  configureJWTCheckForAPI(app, clientID, clientSecret, jwtIgnorePaths)
